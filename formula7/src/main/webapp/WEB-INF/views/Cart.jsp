    ...
    <nav id="myNavbar" class="navbar navbar-light" style="background-color: #f18973;" role="navigation">
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">FORMULA 007</a>
            </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <div class="thumbnail">
                         <a class="thumbnail pull-left" href="#"> <img src="/formula7/myImage/imageDisplay?id=${cart.productId}" style="width:50px;height: 50px" > </a> 
